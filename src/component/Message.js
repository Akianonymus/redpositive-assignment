...
const Message = ({ msg, setMsg, spinner, classes }) => {
  ...
  return (
    <div
      className={
        "bg-gray-200 dark:bg-gray-800 flex flex-row flex-wrap justify-center my-2 p-3 overflow-auto rounded-md shadow-md mx-auto break-all max-h-[33%] w-[90%] lg:w-[70%] " +
        classes
      }
    >
